...
<div class="roomListRoom">
    <div class="roomListRoom__header">
        <a href="{{route('profile.show',$room->user->uuid)}}" class="roomListRoom__author">
    ...
    <div class="roomListRoom__meta">
        <a href="{{route('rooms.show',$room->slug)}}" class="roomListRoom__joined">
            ...
            {{count($room->participants)}} Joined
        </a>
